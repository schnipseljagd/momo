# This config is based on the cachyos-firefox-settings
# See: https://github.com/CachyOS/CachyOS-PKGBUILDS/tree/master/cachyos-firefox-settings
...
sudo tee /usr/lib/firefox/browser/defaults/preferences/cachyos.js >/dev/null <<'EOF'
